...
> = {
  sudoku: {
    ...
    rules: [
      ...
      "Placing a number removes conflicting notes in its row, column, and box. Undo restores them.",
      "Double-tap or double-click a cell with one note to fill that number. Keypad digits turn gray and disable once nine copies are placed.",
      "N toggles notes. Backspace or the eraser button clears your selected entries.",
    ],
    color: 0x566b51,
    pale: 0xe9eee3,
  },
  ...
  killer: {
    ...
    rules: [
      ...
      "Placing a number removes conflicting notes in its row, column, box, and cage. Undo restores them.",
      "Double-tap or double-click a cell with one note to fill that number. Keypad digits turn gray and disable once nine copies are placed.",
      "N toggles notes. Backspace or the eraser button clears your selected entries.",
    ],
    color: 0x8b6266,
  ...
  nurikabe: {
    ...
    rules: [
      ...
      "Tap or drag to cycle each square: sea → island dot → clear. Each square changes once per drag; numbered cells stay land.",
